...
ZEGOEXP_API enum zego_audio_effect_player_instance_index EXP_CALL
...
ZEGOEXP_API unsigned long long EXP_CALL zego_express_audio_effect_player_get_total_duration(
    unsigned int audio_effect_id, enum zego_audio_effect_player_instance_index instance_index);
...
/// @param audio_effect_id ID for the audio effect.
/// @param instance_index audio effect instance index.
ZEGOEXP_API unsigned long long EXP_CALL zego_express_audio_effect_player_get_current_progress(
    unsigned int audio_effect_id, enum zego_audio_effect_player_instance_index instance_index);
...
/// @param instance_index audio effect instance index.
ZEGOEXP_API zego_seq EXP_CALL zego_express_audio_effect_player_load_resource(
